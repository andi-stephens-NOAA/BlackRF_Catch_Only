...
#
0.5 #_fracfemale
0 # M setup: 0=single Par,1=N_breakpoints,2=Lorenzen,3=agespecific;_4=agesp
...
# Males
-3 3 0 0 -1 50 2 0 0 0 0 0.5 0 0 #M2_natM_young_as_exponential_offset(rel_m
# orph_1)
...
# se+1)
 ...
 0.98 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for al
# l estimated recdevs)
