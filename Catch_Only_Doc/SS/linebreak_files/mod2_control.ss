...
#
0.5 #_fracfemale 
1 # M setup: 0=single Par,1=N_breakpoints,2=Lorenzen,3=agespecific;_4=agesp
...
0 #_forecast_recruitment phase (incl. late recr) (0 value resets to maxphas
# e+1)
...
#_if_Fmethod=2;_read_overall_start_F_value;_overall_phase;_N_detailed_input
# s_to_read
...
#
#__Q_setup
#__Q_type_options:_<0=mirror,_0=median_float,_1=mean_float,_2=parameter,_3=
# parm_w_random_dev,_4=parm_w_randwalk,_5=mean_unbiased_float_assign_to_par
# m
#
...
0 0 0 0 #_11_Small
#
#__Cond_0_#_If_q_has_random_component,_then_0=read_one_parm_for_each_fleet_
# with_random_q;_1=read_a_parm_for_each_year_of_index
#__Q_parms_(if_any)
#
#_LO HI INIT PRIOR PR_type SD PHASE
...
#
-5 5 -1.386 -1.386 0 0.5 -1 #_Q_6.Tag_Abundance-Lognormal_prior_<<<_Prior_i
# s_ON
#
...
#_Lo Hi Init Prior Priot_type SD Phase Env Use Dev_minyr Dev_maxyr Dev_sd B
# lock block_fxn
#
...
#Female
-15     15      0       0       -1      10      5       0       0       0  
     0       0.5     0       0       #PEAK
-15     15      0       0       -1      10      5      0       0       0   
    0       0.5     0       0       #ASC_WIDTH
-15     15      0       0       -1      10      5       0       0       0  
     0       0.5     0       0       #DSC_WIDTH
-15     15      -10     -10     -1      10      5       0       0       0  
     0       0.5     0       0       #FINAL
-15     15      1       0       -1      10      -5      0       0       0  
     0       0.5     0       0       #APICAL
#
...
-15     10      -10      -3.7    -1      99      -5      0       0       0 
      0       0.5     0       0       #       INIT    bin     sel
-5      10      0      0.1     -1      99      4       0       0       0   
...
#
# Male
1       40      10      13      -1      99      -5      0       0       0  
     0       0       0       0       #       Peak start
-10     3       -4      -4      -1      99      -5      0       0       0  
     0       0       0       0       #       Top width
-4      12      4       4       -1      99      -5      0       0       0  
     0       0       0       0       #       Asc-width
-2      6       0       2       -1      99      -5      0       0       0  
     0       0       0       0       #       Desc-width
-15     10      5       5       -1      99      -5      0       0       0  
     0       0       0       0       #       INIT bin sel
-5      10      5       5       -1      99      -5      0       0       0  
     0       0       0       0       #       FINAL bin sel
# Female offset
-15     15      0       0       -1      10      5       0       0       0  
     0       0.5     0       0       #PEAK
-15     15      0       0       -1      10      -5      0       0       0  
...
# 1.Trawl 2.Live 3.Dead 4.RecO 5.RecS 6.Onboard 7.Tag 8.MRFSS 9.ORBS 10.Com
# mLog 11.Small   HarmonicEffectiveN_/_MeanInputN_w_VarAdj_from_r4ss
...
#_old 0.648 0.051 0.18 0.039 0.039 0 0 0 0 0 0 #_Length_comps  Iter.1  3.De
# ad 2.3334699 1
# 0.128 0.318 0.034 0.034 0 0 0 0 0 0 0 #_Length_comps  2  4.Rec 1.7985239 
# 0.4804
 1 0.4 0.52 0.078 0.12 1 1 1 1 1 1 #_Length_comps  2  4.Rec 1.7985239 0.480
# 4
...
# 
#_Like_comp_codes:_1=surv;_2=disc;_3=mnwt;_4=length;_5=age;_6=SizeFreq;_7=s
# izeage;_8=catch;
#_9=init_equ_catch;_10=recrdev;_11=parm_prior;_12=parm_dev;_13=CrashPen;_14
# =Morphcomp;_15=Tag-comp;_16=Tag-negbin
#_like_comp fleet/survey phase value sizefreq_method
#
# TOADS:  These are no doubt meaningless in the new model and will need to 
# be redone.
#
1 6 1 1 1 # Onboard    
