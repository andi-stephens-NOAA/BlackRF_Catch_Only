...
4 #_write_parm_values_to_ParmTrace.sso_(0=no,1=good,active;_2=good,all;_3=e
# very_iter,all_parms;_4=every,active)
...
1 #_Number_of_datafiles_to_produce:_1st_is_input,_2nd_is_estimates,_3rd_and
# _higher_are_bootstrap
...
1 #_Depletion_basis:__denom_is:_0=skip;_1=rel_X*B0;_2=rel_X*Bmsy;_3=rel_X*B
# _styr
1 #_Fraction_(X)_for_Depletion_denominator_(e.g._0.4)
1 #_SPR_report_basis:__0=skip;_1=(1-SPR)/(1-SPR_tgt);_2=(1-SPR)/(1-SPR_MSY)
# ;_3=(1-SPR)/(1-SPR_Btarget);_4=rawSPR
3 #_F_report_units:_0=skip;_1=exploitation(Bio);_2=exploitation(Num);_3=sum
# (Frates);_4=true_F_for_range_of_ages
#COND 10 15 #_min_and_max_age_over_which_average_F_will_be_calculated_with_
# F_reporting=4
