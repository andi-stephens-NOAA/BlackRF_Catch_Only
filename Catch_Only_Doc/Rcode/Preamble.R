...
cat("N models", n_models, "\n")


# model names; if you only have one model the label will just be "model"
mod1_label = "California model" 
mod2_label = "Oregon model"  # (north of $40^\\circ 10^\\prime$ N. latitude to the OR-WA border)"
mod3_label = "Washington model" # (south of $40^\\circ 10^\\prime$ N. latitude)"
